...
//Spline mesh and materialSettings  
void AVRCharacter::DrawTeleportPath(const TArray<FVector> &Path)
{
	UpdateSpline(Path);

	for (USplineMeshComponent* SplineMesh : TeleportPathsMeshPool)
	{
	...
	{
		if (TeleportPathsMeshPool.Num() <= i)
		{
			...
			TeleportPathsMeshPool.Add(SplineMesh);

		}

		USplineMeshComponent* SplineMesh = TeleportPathsMeshPool[i];
